...
enum EWatchSignal {
	...
	EW_BUTTON_P_SIG,
	EW_BUTTON_M_SIG,
	EW_SET_CLOCK_MODE_SIG,
	EW_SET_ALARM_MODE
};

// enum EWatchSignal {CLOCK_TICK};
// enum EWatchControlSignal {SET_ALARM_MODE = 3, SET_CLOCK_MODE};
enum EWatchMode {CLOCK_MODE, STOPWATCH_MODE, ALARM_MODE, SET_CLOCK_MODE};
enum EWatchState {CLOCK_STATE, ALARM_STATE, STOPWATCH_STATE, SET_CLOCK_STATE};
